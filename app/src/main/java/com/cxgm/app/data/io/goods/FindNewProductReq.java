 ...
 *
 * @author dean
 * @time 2018/5/11 上午11:45
 */
public class FindNewProductReq extends Request {

    int shopId,pageNum,pageSize;
    public FindNewProductReq(Context context, int shopId, int pageNum, int pageSize) {
        super(context);
        this.shopId = shopId;
    ...
    public RequestParams params() {
        ...
        RequestParams params = new RequestParams(SERVER + Constants.PORT2 + "/homePage/findNewProduct");
