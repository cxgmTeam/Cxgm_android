...
public class FindTopProductReq extends Request {
    ...
    public FindTopProductReq(Context context,int shopId,int pageNum,int pageSize) {
        super(context);
        this.shopId = shopId;
    ...
    public RequestParams params() {
        ...
        RequestParams params = new RequestParams(SERVER + Constants.PORT2 + "/homePage/findTopProduct");
