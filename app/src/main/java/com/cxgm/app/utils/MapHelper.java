 ...
 *
 * @author dean
 * @time 2018/5/7 下午5:45
 */
public class MapHelper extends BDAbstractLocationListener {

    LocationClient mLocationClient;
    LocationCallback mCallback;

    public MapHelper(Context context,LocationCallback callback) {
        mCallback = callback;
...
//        int errorCode = bdLocation.getLocType();//获取定位类型、定位错误返回码，具体信息可参照类参考中BDLocation类中的说明
    ...
    /**
     * 傻X百度 为什么把 BDAbstractLocationListener 搞成abstract的
     */
